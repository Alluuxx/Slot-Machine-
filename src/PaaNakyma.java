...
public class PaaNakyma extends JFrame {
    ...
    int havityt = 0;
    int voittotappio;
    double alkuperainenSaldo;
    private static final DecimalFormat df = new DecimalFormat("0.00");
    private static final int TASK_DURATION_IN_SECONDS = 2 * 1000;

    public void paaNakyma(JFrame frame) throws SQLException, IOException {
        ...
        double tietokantasaldo = db.getSaldo();
        alkuperainenSaldo = tietokantasaldo;
        String uusi = df.format(tietokantasaldo);

        JLabel saldonSuuruus = new JLabel(uusi + "€");
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                if ((ey == ty && ty == ky) || (ek == tk && tk == kk) || (ea == ta && ta == ka)
                                    ...
                                    havityt = 0;
                                    ilmoitus2.setText(
                                            "VOITIT  " + df.format(kerroin * Double.parseDouble(db.getPanos())) + "€");
                                } else {
                                    havityt++;
                                }
